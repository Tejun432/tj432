...
public class LeasingCost {
    ...
    private static final Object fuelType = null;
	...
	public static Vehicle createVehicle(String description){
      ...
      Fuel fuel;
        ...
        Vehicle newV = new Vehicle (name, fuel, lease);
        return newV;

    }
    public static String getname(String s, String description){
        String s1 = description.substring(description.indexOf(s)+String.valueOf(s).length(),description.indexOf(";",description.indexOf(s)));
        return s1;
    }
	...
	public static void computeCO2EmissionsAndCost( Vehicle[] vehicles, double gasPrice, double electricityPrice ){
       ...
       for(Vehicle vehicle : vehicles){
           ...
           if(vehicle.getFuel().getType()== 1){
            ...
            vehicle.setTotalCost(computeLeaseCost(dueAtSigning,numberOfMonth, monthlyCost)+ computeFuelCost(numberOfMonth,usage,mileageAllowance,fuelPrice));
